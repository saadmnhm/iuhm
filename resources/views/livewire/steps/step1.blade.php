<div class="step-1">
    <h3 class="step-title">1- General Informations</h3>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="field-gender">
            <label for="gender" class="block disc mb-2 font-semibold">Genre *</label>
    ...
    <div class="field-address mt-4">
        <label for="address" class="block disc mb-2 font-semibold">Adresse *</label>
    ...
    <div class="field-email mt-4">
        <label for="email" class="block disc mb-2 font-semibold">Email *</label>
    ...
    <div class="field-phone mt-4">
        <label for="phone" class="block disc mb-2 font-semibold">Téléphone *</label>
