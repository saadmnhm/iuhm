<div>
    ...
    @elseif ($matricule_null > 0)
        <div class="bg-yellow-100 border border-yellow-400 text-yellow-700 px-4 py-3 rounded-lg mb-6">
            <p>Attention : <a href="{{ route('admin.candidats.index', ['matriculeFilter' => 'without']) }}" class="text-yellow-700 underline">{{ $matricule_null }} bénéficiaire(s)</a> n'ont pas de matricule attribué.</p>
            <p>Veuillez vérifier les fiches d'inscription et attribuer des matricules pour assurer une gestion correcte des bénéficiaires.</p>
        </div>
    @endif
