            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-4 py-3 text-gray-500">31</td>
                        <td class="px-4 py-3">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <div class="font-medium text-gray-800">saad saad</div>
                                    <div class="text-xs text-gray-400">saadmnhm@gmail.com</div>
                                </div>
                            </div>
                        </td>

                        <td class="px-4 py-3 text-gray-700">Mon Projet Test</td>
                        <td class="px-4 py-3">
                            <span
                        ...
                        <td class="px-4 py-3 text-center">
                            <a href="http://127.0.0.1:8000/admin/candidat/3/submissions"
