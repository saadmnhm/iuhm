<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <h2 class="text-lg font-bold text-gray-900 mb-6 flex items-center gap-2">
            <i class="ri-user-add-line text-indigo-600"></i> Nouvel Employé
        </h2>
        ...
        <form wire:submit.prevent="save" class="space-y-5">
            ...
            <div>
                <label class="block text-xs font-semibold text-gray-700 mb-2">Photo de l'employé</label>
            ...
            <div class="flex justify-end gap-3 pt-4 border-t border-gray-100">
                ...
                <button type="submit" class="px-6 py-2.5 text-sm font-semibold text-white bg-indigo-600 hover:bg-indigo-700 rounded-lg shadow transition">
                    <i class="ri-save-line mr-1"></i> Créer
                </button>
            </div>
        </form>
    </div>
