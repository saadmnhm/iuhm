<div>
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Gestion des Localisations</h2>
            <p class="text-sm text-gray-500 mt-1">Gérer les régions, villes et préfectures du Maroc</p>
        </div>
        <button wire:click="openModal"
            ...
            <i class="ri-add-line text-lg"></i> Nouvelle localisation
        </button>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 mb-6">
        <div class="relative">
            ...
            <input type="text" wire:model.live="search" placeholder="Rechercher région, ville, préfecture..."
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 hover:shadow-md transition group">
            <div class="flex items-start justify-between">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <h4 class="font-semibold text-gray-800">{{ $address->region }}</h4>
                        <p class="text-sm text-gray-500 mt-1">{{ $address->city }}</p>
                        <span class="inline-block mt-2 px-2 py-0.5 bg-gray-100 text-gray-600 text-xs rounded font-medium">{{ $address->prefecture }}</span>
                    </div>
                </div>
        ...
        <div class="col-span-full bg-white rounded-xl shadow-sm p-12 text-center">
            ...
            <h3 class="text-lg font-semibold text-gray-700 mb-1">Aucune localisation trouvée</h3>
            <p class="text-sm text-gray-500">Ajoutez des localisations pour les rendre disponibles aux candidats.</p>
        </div>
        @endforelse
    </div>
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg z-10 overflow-hidden">
            ...
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-indigo-50 to-purple-50">
                <h3 class="text-lg font-bold text-indigo-800 flex items-center gap-2">
                    ...
                    {{ $editMode ? 'Modifier la localisation' : 'Nouvelle localisation' }}
                </h3>
            ...
            <form wire:submit.prevent="save" class="p-6 space-y-4">
                <div>
                    ...
                    <input type="text" wire:model="region" placeholder="Ex: Casablanca-Settat"
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1">Préfecture *</label>
                        <input type="text" wire:model="prefecture"
                               class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400 outline-none transition text-sm">
