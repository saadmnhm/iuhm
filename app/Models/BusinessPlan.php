...
class BusinessPlan extends Model
{
    ...
    {
        return $this->hasMany(BusinessPlanEmployee::class);
    }

    public function presentations()
    {
        return $this->hasMany(BusinessPlanPresentation::class);
    }

    public function deliveries()
    {
        return $this->hasMany(BusinessPlanDelivery::class);
    }

    public function equipment()
    {
        return $this->hasMany(BusinessPlanEquipment::class);
    }

    public function rawMaterials()
    {
        return $this->hasMany(BusinessPlanRawMaterial::class);
    }

    public function financials()
    {
        return $this->hasOne(BusinessPlanFinancial::class);
    }
